...
def parse_args() -> argparse.Namespace:
    ...
    # setting for tasks
    parser.add_argument('--classification_num', type=float, default=2,
                        help='the number of classes for code smell detection (2: smell vs no-smell)')
    
    # code smell detection
    parser.add_argument('--smell_threshold', type=float, default=0.5,
                        help='threshold for code smell classification')
    parser.add_argument('--batch_size_smell', type=int, default=128,
                        help='batch size for code smell detection')
    parser.add_argument('--smell_test_supervised', default=True, action='store_false',
                        help='whether to test code smell detection task.')
    parser.add_argument('--smell_val_size', type=float, default=0.1,
                        help='Size of validation dataset for code smell')
    parser.add_argument('--smell_test_size', type=float, default=0.1,
                        help='Size of test dataset for code smell')
    
    # legacy code clone parameters (keeping for compatibility)
